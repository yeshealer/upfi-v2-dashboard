        ...
        <div className='mt-32 lg:mt-48'>
            ...
            <div className='flex flex-wrap gap-5 justify-between'>
                {PartnerDetails.map(item => (
                    <div key={item.name} className='bg-gradient-to-r from-zinc-600/20 to-zinc-700/30 border border-yellow-600/20 p-1 sm:p-4 rounded-md backdrop-blur flex items-center justify-center w-full sm:w-2/5 md:w-auto'>
