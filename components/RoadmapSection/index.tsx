        ...
        <div className='mt-32 lg:mt-48'>
            ...
            <div className='flex flex-col gap-4'>
                {RoadmapDetails.map(item => (
                    <div key={item.period} className='bg-gradient-to-r from-zinc-600/20 to-zinc-700/30 border border-yellow-600/20 px-3 md:px-10 py-3 md:py-6 rounded-md backdrop-blur'>
                        ...
                        <div className='pl-6 md:pl-12'>
                            {item.details.map(detail => (
                                <div key={detail} className='tracking-wider text-sm text-yellow-200 opacity-70 flex items-start gap-2 mt-1'>
